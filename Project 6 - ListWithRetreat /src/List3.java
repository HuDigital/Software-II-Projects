...
public class List3<T> extends ListSecondary<T> {
    ...
    private void createNewRep() {
        ...
        // Initializes the first and second smart node
        this.preStart = new Node();
        this.postFinish = new Node();

        // Initializes the relationships between preStart and postFinish
    ...
    public final void addRightFront(T x) {
        ...
        // Initializes rightFront and lastLeft
        Node newNode = new Node();
        Node lastLeft = this.lastLeft;
        Node oldNode = lastLeft.next;

        // Assigns x to the the data of rightFront
        newNode.data = x;

        // Assigns the next node for rightFront
        ...
        // Increments the length of the right
        this.rightLength++;
    ...
    public final T removeRightFront() {
        ...
        // Initializes rightFront and lastLeft
        Node lastLeft = this.lastLeft;
        Node rightFront = lastLeft.next;
        Node rightNext = rightFront.next;

        // Assigns x to the the data of rightFront
        T x = rightFront.data;

        // Assigns rightNext as the next node for lastLeft
        lastLeft.next = rightNext;
        rightNext.previous = lastLeft;

        // Decrements the length of the right
        this.rightLength--;

        assert this.conventionHolds();

        // Returns the data from rightFront
        return x;
    ...
    public final void retreat() {
        ...
        Node lastLeft = this.lastLeft;
        this.lastLeft = lastLeft.previous;
