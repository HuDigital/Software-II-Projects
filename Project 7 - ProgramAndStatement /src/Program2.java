...
public class Program2 extends ProgramSecondary {
    ...
    private void createNewRep() {
        ...
        // Initializes the name, context, and body of this
        this.name = "Unnamed";
    ...
    public final void setName(String n) {
        ...
        // Sets the name equal to the string n
        this.name = n;
    ...
    public final Map<String, Statement> newContext() {
        ...
        // Returns an empty map with the components of this.context
    ...
    public final void swapContext(Map<String, Statement> c) {
        ...
        // Duplicates and clears c
        Map<String, Statement> copy = c.newInstance();
        copy.transferFrom(c);

        // Swaps the values of both c and this.context
        c.transferFrom(this.context);
        this.context.transferFrom(copy);
    ...
    public final Statement newBody() {
        ...
        // Returns an empty statement with the components of this.body
    ...
    public final void swapBody(Statement b) {
        ...
        // Duplicates and clears b
        Statement copy = b.newInstance();
        copy.transferFrom(b);

        // Swaps the values of both b and this.body
        b.transferFrom(this.body);
        this.body.transferFrom(copy);
