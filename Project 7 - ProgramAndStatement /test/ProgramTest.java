...
public abstract class ProgramTest {
    ...
    /**
     * Test newContext with a populated context.
     */
    @Test
    public final void testNewContextPopulated() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_1);
        Program pRef = this.createFromFileRef(FILE_NAME_1);
        Map<String, Statement> cRef = pRef.newContext();
        cRef.add("newCommand", pRef.newBody());

        /*
         * The call
         */
        Map<String, Statement> cTest = pTest.newContext();
        cTest.add("newCommand", pTest.newBody());
    ...
    /**
     * Test swapContext with an empty context.
     */
    @Test
    public final void testSwapContextEmpty() {
        ...
        Program pTest = this.createFromFileTest(FILE_NAME_1);
        Program pRef = this.createFromFileRef(FILE_NAME_1);
        Map<String, Statement> emptyContext = pTest.newContext();
        Map<String, Statement> emptyContext2 = pTest.newContext();

        /*
         * The call
         */
        pTest.swapContext(emptyContext);
        pRef.swapContext(emptyContext2);
    ...
    /**
     * Test swapBody with an empty body.
     */
    @Test
    public final void testSwapBodyEmpty() {
        ...
        Program pTest = this.createFromFileTest(FILE_NAME_1);
        Program pRef = this.createFromFileRef(FILE_NAME_1);
        Statement emptyBody = pTest.newBody();
        Statement emptyBody2 = pTest.newBody();

        /*
         * The call
         */
        pTest.swapBody(emptyBody);
        pRef.swapBody(emptyBody2);
